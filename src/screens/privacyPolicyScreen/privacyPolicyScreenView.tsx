  ...
  return (
    <SafeAreaView style={privacyPolicyScreenStyles.rootContainer}>
      <View style={globalStyles.topContainer}>
        <ParagraphComponent style={globalStyles.headerName} paragraphName={'PRIVACY POLICY'} />
      ...
      <ScrollView style={privacyPolicyScreenStyles.centerContainer}>
        ...
        <ParagraphComponent
          ...
          paragraphName={'SUMMARY OF KEY POINTS'}
        />
        <TextComponent
        ...
        />
        <TextComponent textStyles={globalStyles.boldText} text={'What are your rights?'} />
        <TextComponent
          text={
        ...
        />
        <ParagraphComponent paragraphName={'TABLE OF CONTENTS'} />
        <View style={globalStyles.tableContainer}>
          <TextComponent text={'1. WHAT INFORMATION DO WE COLLECT?'} />
          <TextComponent text={'2. HOW DO WE PROCESS YOUR INFORMATION?'} />
          <TextComponent
            text={'3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?'}
          />
          <TextComponent text={'4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?'} />
          <TextComponent text={'5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?'} />
          <TextComponent text={'6. HOW LONG DO WE KEEP YOUR INFORMATION?'} />
          <TextComponent text={'7. HOW DO WE KEEP YOUR INFORMATION SAFE?'} />
          <TextComponent text={'8. DO WE COLLECT INFORMATION FROM MINORS?'} />
          <TextComponent text={'9. WHAT ARE YOUR PRIVACY RIGHTS?'} />
          <TextComponent text={'10. CONTROLS FOR DO-NOT-TRACK FEATURES'} />
          <TextComponent text={'11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?'} />
          <TextComponent text={'12. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?'} />
          <TextComponent text={'13. DO WE MAKE UPDATES TO THIS NOTICE?'} />
          <TextComponent text={'14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?'} />
          <TextComponent
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'6. HOW LONG DO WE KEEP YOUR INFORMATION?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'7. HOW DO WE KEEP YOUR INFORMATION SAFE?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'8. DO WE COLLECT INFORMATION FROM MINORS?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'9. WHAT ARE YOUR PRIVACY RIGHTS?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'12. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
        ...
        <ParagraphComponent
          textStyles={globalStyles.paragraphName}
          paragraphName={'13. DO WE MAKE UPDATES TO THIS NOTICE?'}
        />
        <TextComponent textStyles={globalStyles.boldText} text={'In Short:'} />
        <TextComponent
          textStyles={globalStyles.descriptionText}
