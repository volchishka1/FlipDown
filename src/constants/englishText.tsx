...
export const INSERT_YOUR_LINK = 'Insert TT link';
...
export const IF_YOU_NEED =
  'If you need to download videos from TT and you do not know how to do it, we advise you to pay attention to the FlipDown project. FlipDown is an application that allows you to deal with the task in just a few seconds. The service is characterized by a simple and clear interface, which means that it allows you to find and download any videos from TT, and will be easy to understand for teenagers and older users. There will be no difficulties because we offer the best solution to save clips on any device.';
...
export const OPEN_THE_APP =
  'open the FlipDown application and paste the copied link into the input field.';
export const THE_FINAL_STEP =
  ...
  '\n' +
  'On this application, you can download not only short video clips but also music from TT. The algorithm of actions does not change. It is just as easy and simple.\n';
export const BENEFITS = 'Benefits of FlipDown. What should a user know?';
export const IF_YOU_CHOSEN =
  'If you have chosen FlipDown for downloading files, you definitely have not made a mistake, because the service has a lot of advantages. The main pros are:';
export const NO_USER_FEES =
  'no user fees. You really do not have to pay when downloading clips from TT without a watermark, even if there is a lot of content and its size is quite large;';
export const HIGH_QUALITY =
  'high-quality videos. FlipDown allows you to download clips without loss of quality, which means you can watch them on your device in the best possible way;';
...
export const CONFIDENTIALITY =
  'confidentiality. FlipDown will not save user data even if you open the application daily and download a lot of content.';
export const USING_THE_FLIPDOWN =
  'Using the FlipDown application is not difficult at all, and there is no need to register and authorize. There is no need to download additional extensions, plugins or add-ons.\n' +
  '\n' +
